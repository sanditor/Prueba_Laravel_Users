...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 m-5">
            ...
            <div class="card">
                <div class="card-header">Perfil de mi Cuenta</div>
                ...
                <form method="POST" action="{{ route('user.update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="hobbies" type="text" class="form-control{{ $errors->has('hobbies') ? ' is-invalid' : '' }}" name="hobbies" value="{{ Auth::user()->hobbies }}">
